  ...
  const steps = [
    {
      ...
      description: "Получаете личную реферальную ссылку",
    },
    {
      icon: "Share2",
      title: "Делитесь с аудиторией",
      description: "Клиенты переходят и оформляют карту Z-Bank",
    },
    {
      icon: "Coins",
      title: "Получаете вознаграждение",
      description: "За каждого активного клиента — автоматически",
    },
  ];
